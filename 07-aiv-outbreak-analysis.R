...
# 2-1. Input path ----------
EU_shp_path <- "C:/Users/bruce/R/aiv-gpboost/EU_100km_fishnet_simple_by_distance/EU_100km_fishnet_simple_by_distance.shp"
chicken_density_path <- "C:/Users/bruce/R/aiv-gpboost/livestock_density_10km/chicken_livestock_density_10km.csv"
duck_density_path <- "C:/Users/bruce/R/aiv-gpboost/livestock_density_10km/duck_livestock_density_2015_10km.csv"
EU_aiv_2022_path <- "C:/Users/bruce/R/aiv-gpboost/aiv_fixed_data/EU aiv fixed data 2022.csv"
EU_aiv_2021_path <- "C:/Users/bruce/R/aiv-gpboost/aiv_fixed_data/EU aiv fixed data 2021.csv"
birdname_folder_path <- "C:/Users/bruce/R/aiv-gpboost/all-birds-abd-new"

# 2-2. Output path ----------
chicken_density_output_path <- "C:/Users/bruce/R/aiv-gpboost/chicken_density.png"
duck_density_output_path <- "C:/Users/bruce/R/aiv-gpboost/duck_density.png"
domestic_outbreak_output_path <- "C:/Users/bruce/R/aiv-gpboost/Domestic_outbreak_map.png"
wild_outbreak_output_path <- "C:/Users/bruce/R/aiv-gpboost/Wild_outbreak_map.png"
write_csv_date <- '20260811'
aiv_analysis_output_folder <- 'C:/Users/bruce/R/aiv-gpboost/aiv_analysis_new/'
weighted_abundance_output_folder <- 'C:/Users/bruce/R/aiv-gpboost/weighted_abundance/'
...
# 3-7. Combine AIV outbreak records (2021?V2022), extract year-month information ----------
...
get_weighted_abundance <- function(abundance){
  ...
  weighted_abundance$unweighted_abundance <- weighted_abundance$relative_abundance
  ...
  weighted_abundance_result <- weighted_abundance %>%
    ...
    group_by(Id, stage) %>%
    summarise(
      sum_weighted_abundance = sum(weighted_abundance, na.rm = TRUE),  # ???[?v?ȻE?X
      .groups = "drop"
    ) %>%
...
rbind_all_stages_data <- function(all_df, weighted_abundance_result, EU_center_coordinate_df){
  ...
  # merge data from stage1?Vstage3
...
save_outbreak_and_abundance_image <- function(EU.map, stage_rbind_df, stage, birdname, output_folder){
  ...
  if (file.exists(output_path)) {
    message("Graphic saved successfully?I")
  } else {
...
sub_bird_name_vector <- all_bird_name_vector
